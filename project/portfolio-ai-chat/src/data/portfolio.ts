...
export const profile = {
  ...
  tagline:
    "Apasionado del desarrollo de software: me gustan los retos y aprender todo el tiempo. Con la IA pasé de picar código a planificar y estructurar el trabajo de agentes para crear lo que una persona sola no podría.",
  // Descripción larga para la sección "Sobre mí"
  sobreMi:
    "Soy Seiji Tsumura, Analista Programador egresado de la Universidad ORT con +5 años de experiencia. Trabajé 5 años en sistemas en la Jefatura de Policía de Montevideo y 2 años como encargado de sistemas en Toque y Toque. Sinceramente soy un apasionado del desarrollo: me gustan los retos de esta profesión y aprender todo el tiempo. Con la inteligencia artificial cambió mi manera de programar: ahora veo todo el panorama y me encargo de planificar, crear estructuras para que los agentes de IA las sigan y mejorar procesos.",
